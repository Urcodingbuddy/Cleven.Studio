...
const plans : Plan[] = [
    ...
    {
        category : 'speed-optization',
        name: "Standard Plan",
        plan : 'speed-optimzation-standard',
        monthlyPrice: "$49/month",
        yearlyPrice: "$529.2/year",
        slug : 'speed-optimazation-standard',
        features: [
        ...
        ],    },
    {
        category : 'speed-optization',
        name: "premium Plan",
        plan : 'speed-optimzation-premium',
        monthlyPrice: "$79/month",
        yearlyPrice: "$853.2/year",
        slug : 'speed-optimazation-premium',
        features: [
