        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ml-38 max-w-xl">
            <Link href="https://discord.gg/clevenstudio" target="_blank">
              <div className="bg-[#161616] p-4 rounded-lg flex items-center space-x-3 transition-all duration-300 hover:bg-[#1A1A1A] hover:shadow-lg hover:translate-x-1 cursor-pointer">
