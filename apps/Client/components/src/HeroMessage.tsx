    ...
    return (
        <>
            <section id="heroMessage_head">
                <div id="intoMssg" className="h-[40rem] w-full px-4 sm:px-6 lg:px-8 max-w-7xl flex justify-center items-center mx-auto">
                    <div className="max-w-7xl w-full flex flex-col md:flex-row gap-5 px-4">
                        <div id="leftMssg" className="w-full lg:w-1/2 h-full text-white">
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold flex z-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500">
                                Who said maintaining a website has to be hassle?
                            </h1>
                        </div>
