...
export const HeroMessage = () => {
    return(
        ...
        <section id="heroMessage_head">
            <div id="intoMssg" className="h-[50vh] w-screen flex justify-center items-center px-24">
                <div id="leftMssg" className="w-1/2 h-full  text-white flex items-center">
                <h1 className="text-[2.4rem] font-bold leading-10 " >Who said maintaining a website <br/> has to be a hassle?</h1>
                </div>
