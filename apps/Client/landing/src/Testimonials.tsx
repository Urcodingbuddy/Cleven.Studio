    ...
    return (
        <div className="rounded-md w-full flex flex-col my-32  items-center justify-center relative overflow-hidden cursor-pointer">
            <div className="max-w-7xl flex">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold z-2 mb-26 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500">
                    Testimonial&apos;s
                </h1>
            </div>
